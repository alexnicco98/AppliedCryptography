...
# Creazione directory per i file del server.
...
# Creazione directory per i file dei client.
...
# Inizializzazione file serial se non è stato già creato.
...
# Creazione index file se non esiste.
...
# Creazione chiave privata e certificato della CA
...
# Creazione chiave privata e chiave pubblica del server
...
# Creazione hiave privata e chiave pubblica dello user
...
# Rimozione file temporanei usati per la creazione
rm -f ./*.pem ./*.crt ./*.req
